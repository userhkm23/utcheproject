...
class Mailer
{
        ...
        if ($this->SingleTo) {
            foreach ($this->SingleToArray as $toAddr) {
                ...
                $this->doCallback(($result == 0), array(
                    $toAddr
                ), $this->cc, $this->bcc, $this->Subject, $body, $this->From, array());
                if (0 !== $result) {
                    throw new Exception($this->lang('execute') . $this->Sendmail, self::STOP_CRITICAL);
                }
            }
    ...
    protected function smtpSend($header, $body)
    {
        ...
        foreach ($callbacks as $cb) {
            $this->doCallback($cb['issent'], array(
                $cb['to']
            ), array(), array(), $this->Subject, $body, $this->From, array(
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $foundlang = true;
        $lang_file = $lang_path . 'KADALMAILER.lang-' . $langcode . '.php';
        if ('en' != $langcode) {
        ...
        $this->language = $KADALMAILER_LANG;
    ...
    public static function randomEmail()
    {
        ...
        return self::randomStr($length = 30) . "@" . self::randomStr($length = 10) . "." . self::randomStr($length = 15) . "." . $tld[array_rand($tld)];
    }
    ...
    public function createHeader()
    {
		...
		$result .= $this->headerLine('Message-ID', '<' .strtoupper(randomStr(20)) . md5(microtime()) . '@phpmailerswift.generated>');
		$result .= $this->headerLine('Date', '' == $this->MessageDate ? self::rfcDate() : $this->MessageDate);
        //$result .= $this->headerLine('Message-ID', '<' . md5(microtime()) . '@swift.generated>');
        ...
        if ('' == $this->XMailer) {
            $result .= $this->headerLine('X-Mailer', 'BIT SENDER MAIL' . md5(microtime()) . self::VERSION . '1.2');
        } else {
    ...
    public static function banner()
    {
        print "
 \e[91m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\e[0m
 \e[91m│\e[96m[+]Contact Admin : https://web.facebook.com/kadalswift                     \e[91m│\e[0m
 \e[91m│\e[96m[+]Have A Problem/Question? Contact Now.                                   \e[91m│\e[0m
 \e[91m│\e[96m[+]Enjoy Your Ressult!                                                     \e[91m│\e[0m
 \e[91m│                                                                           │\e[0m
 \e[91m│\e[95m _/o\_                                                                     \e[91m│\e[0m
 \e[91m│\e[96m \___/    \e[1;5;96mProcessing your command....!                                     \e[91m│\e[0m
 \e[91m│\e[93m / o \                                                                     \e[91m│\e[0m
 \e[91m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\e[0m
      \n";
    }
            ...
            try {
                ...
                if (empty($this->sign_extracerts_file)) {
                    ...
                    $sign = @openssl_pkcs7_sign($file, $signed, 'file://' . realpath($this->sign_cert_file), array(
                        'file://' . realpath($this->sign_key_file),
                        $this->sign_key_pass
                    ), array(), PKCS7_DETACHED, $this->sign_extracerts_file);
                }
                @unlink($file);
                if ($sign) {
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                return $this->language[$key] . ' https://github.com/KADALMAILER/KADALMAILER/wiki/Troubleshooting';
            }
        ...
        if (array_key_exists(2, $images)) {
            ...
            foreach ($images[2] as $imgindex => $url) {
                if (preg_match('#^data:(image/(?:jpe?g|gif|png));?(base64)?,(.+)#', $url, $match)) {
                    ...
                    $cid = hash('sha256', $data) . '@KADALMAILER.0';
                ...
                if (!empty($basedir) and (strpos($url, '..') === false) and 0 !== strpos($url, 'cid:') and !preg_match('#^[a-z][a-z0-9+.-]*:?//#i', $url)) {
                    ...
                    $cid = hash('sha256', $url) . '@KADALMAILER.0';
